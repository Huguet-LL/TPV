...
public class Mesa1Otras extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mesa1_otras);

        String itemName = "";
        double itemPrice = 0.0;

        listaOtras = new ArrayList<>();     otrasvist = (ListView) findViewById(R.id.otrasvist1);

        final DDBBM1Helper dbHelper = new DDBBM1Helper(this);
        final DDBBPreciosHelper LPHelper = new DDBBPreciosHelper(this);

        Btn1 = (Button) findViewById(R.id.sinalcohol1);
        Btn2 = (Button) findViewById(R.id.singluten1);
        Btn3 = (Button) findViewById(R.id.tyris1);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, listaOtras);
        otrasvist.setAdapter(adapter);
        ...
        for (Button button : buttonList) {
            ...
            if(cursor.moveToFirst()) {
                ...
                Toast.makeText(Mesa1Otras.this, "Producto" + itemName + "no encontrado", Toast.LENGTH_SHORT).show();
            }
            i++;
        }
        ...
        Btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(cursor.moveToFirst()) {
                    ...
                    Toast.makeText(Mesa1Otras.this, "Producto SIN ALCOHOL no encontrado", Toast.LENGTH_SHORT).show();
                }
            }
        });
        Btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(cursor.moveToFirst()) {
                    ...
                    Toast.makeText(Mesa1Otras.this, "Producto SIN GLUTEN no encontrado", Toast.LENGTH_SHORT).show();
                }
            }
        });
        Btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(cursor.moveToFirst()) {
                    ...
                    Toast.makeText(Mesa1Otras.this, "Producto TYRIS no encontrado", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
