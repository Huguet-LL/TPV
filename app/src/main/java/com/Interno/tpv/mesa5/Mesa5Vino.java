...
public class Mesa5Vino extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mesa5_vino);

        listaRefres = new ArrayList<>();
        reflist = (ListView) findViewById(R.id.vinvist5);

        Btn1 = (Button) findViewById(R.id.cBlanco5);
        Btn2 = (Button) findViewById(R.id.cTinto5);
        Btn3 = (Button) findViewById(R.id.cAlba5);
        Btn4 = (Button) findViewById(R.id.calYmocho5);
        Btn5 = (Button) findViewById(R.id.TintoVer5);
        ...
        Btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getApplicationContext(), "Se ha añadido COPA VINO BLANCO a la MESA 5",Toast.LENGTH_SHORT).show();
        ...
        Btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getApplicationContext(), "Se ha añadido COPA VINO TINTO a la MESA 5",Toast.LENGTH_SHORT).show();
        ...
        Btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getApplicationContext(), "Se ha añadido COPA ALBARIÑO a la MESA 5",Toast.LENGTH_SHORT).show();
        ...
        Btn4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getApplicationContext(), "Se ha añadido CALIMOCHO a la MESA 5",Toast.LENGTH_SHORT).show();
        ...
        Btn5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getApplicationContext(), "Se ha añadido TINTO DE VERANO a la MESA 5",Toast.LENGTH_SHORT).show();
